...
/** Friendly 404-ish state shown when a `/content/$apiId` route targets a module that does not exist. */
  ...
  return (
    <section className="mx-auto max-w-md py-16 text-center">
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        No module with api id <span className="font-mono">{apiId}</span> exists.
      </p>
