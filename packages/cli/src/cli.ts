...
// One folder per module (modules/<apiId>/). This schema.ts is files-first — edit it as code; the Builder
// write-route (PUT /builder/modules/:apiId) may also rewrite it. Lifecycle hooks go in hooks.ts (this
// folder), custom logic in services.ts / controller.ts.
